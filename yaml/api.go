...
//func main() {
//	k := NewYaml()
//	fmt.Println("getConn c",k.getConn("c"))
//	test := map[string][]string{"a": {"a1", "a2", "a3"},"b":{"b1","b2","b3"},"c":{"c1","c2","c3"}}
//	k.setConn(test)
//	fmt.Println("getConn a",k.getConn("a"))
//	//k.delConn([]string{"a"})
//	log.Println("list",k.ListConn())
//}